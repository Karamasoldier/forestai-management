# forestai/agents/geo_agent/data_loaders/bdtopo/base_loader.py
...
class BaseBDTopoLoader:
    """
    Classe de base pour le chargeur de données BD TOPO de l'IGN.
    
    Fournit les fonctionnalités communes de chargement et d'indexation des fichiers.
    """
